<?php
    ...
    echo ($alert->sweetHead("Envío de Token"));
    ...
    try {
        ...
        if ($email) {
            ...
            echo ($alert->sweetOK("../verificacion_token.php","Se ha enviado el código de recuperación a su correo:", "$email"));
        } else {
            echo($alert->sweetWar("../gestion/gestion_usuarios.php","No se encontró un usuario con ese nombre"));
        }
    } catch (Exception $e) {
        echo($alert->sweetError("../gestion/gestion_usuarios.php","El mensaje no pudo ser enviado","Mailer Error: $mail->ErrorInfo"));
    }
