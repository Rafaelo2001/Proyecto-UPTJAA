<?php
    ...
    // Solicita los documentos necesarios para ejecutar el script
    require "conexion.php";
    require "sweet.php";

    $user  = new CodeaDB();         // Inicia un nuevo objeto de clase CodeaDB de conexion.php
    $alert = new SweetForInsert();  // Inicia un nuevo objeto de clase SweetForInsert de sweet.php

    // Explicado en sweet.php
    ...
    $obs = $_POST['obs'];
        ...
        try {
            ...
            // Si la cedula del paciente ya esta registrada, nos saltamos este if; sino, se ejecuta
            if(!$buscar_ci_persona){
                ...
                // Enviando PERSONA
                    $idDireccion = $user->buscarONE('direccion','ID_Direccion','ID_Direccion');
            ...
            // Si no esta registrada, se ejecuta el if; sino, muestra error
            ...
            // Atrapamos cualquier exception que se ejecute y mostramos un mensaje de alerta
