<?php
    ...
    if ($result) {
        ...
        if ($error == 1) {
            echo($alert->sweetError("./Gestion-BDD.php","Error en Backup","Ocurrio un error inesperado al crear la copia de seguridad"));
        } else {
            ...
            if (fwrite($handle, $sql)) {
                fclose($handle);
                echo($alert->sweetOK("./Gestion-BDD.php","Copia de seguridad realizada con éxito"));
            } else {
                echo($alert->sweetError("./Gestion-BDD.php","Error en Backup","Ocurrio un error inesperado al crear la copia de seguridad"));
            }
        }
