    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-content">
                <h2>Misión</h2>
                <p>
                    Ser los líderes en brindar un diagnóstico rápido, personalizado y de la más alta calidad en patología 
                    quirúrgica y citopatología.
                </p>
                <h2>Visión</h2>
                <p>
                    Posicionarnos como el laboratorio de patología quirúrgica y citopatología con el más alto reconocimiento 
